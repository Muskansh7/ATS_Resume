# ats_backend/ml/missing_skills.py
...
def get_missing_skills(found_skills, job_role=None):
    ...
    1. Explicit job role (if provided)
    2. Inferred role from resume skills (if job role missing)
    """
